...
Provides utilities for managing copyright headers of `The Maximus Core
...
A script to optimize png files in the maximus
...
If there are any errors the return value will be 1 and output like this will be printed:
    ...
    .../64/test_maximus: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_maximus: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_maximus: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_maximus: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
