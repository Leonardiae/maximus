# Linearize
Construct a linear, no-fork, best version of the Maximus blockchain.
...
JSON-RPC server. Running `maximusd` or `maximus-qt -server` will be sufficient.
...
* `input`: maximusd blocks/ directory containing blkNNNNN.dat
