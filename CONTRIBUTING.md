Contributing to Maximus Core
============================

The Maximus Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Maximus Core
...
Before you start contributing, familiarize yourself with the Maximus Core build
system and tests. Refer to the documentation in the repository on how to build
Maximus Core and how to run the unit and functional tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/maximus-chain/maximus/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.
...
Most communication about Maximus Core development happens on Discord Server.
...
fork of Maximus Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the Maximus Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Maximus
Network Protocol consensus changes.

Whether a pull request is merged into Maximus Core rests with the project merge
...
Patches that change Maximus consensus rules are considerably more involved than
...
Where a patch set proposes to change the Maximus consensus, it must have been
...
The review process is normally fairly responsive on the Maximus Core repository, however
...
The project leader is the release manager for each Maximus Core release.
