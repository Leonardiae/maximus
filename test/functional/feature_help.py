...
"""Verify that starting maximusd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start maximusd with -h for help text")
        ...
        self.log.info("Start maximusd with -version for version information")
        ...
        self.log.info("Start maximusdd with -fakearg to make sure it does not start")
