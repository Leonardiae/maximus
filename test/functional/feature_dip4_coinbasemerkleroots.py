...
class LLMQCoinbaseCommitmentsTest(MaximusTestFramework):
    def set_test_params(self):
        self.set_maximus_test_params(4, 3, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as MaximusTestFramework doesn't support this atm)
