...
from test_framework.messages import maximushash, hash256
...
def maximushash_reversed(byte_str):
    return maximushash(byte_str)[::-1]
...
class ZMQTest (BitcoinTestFramework):
    ...
    def _zmq_test(self):
        ...
        for x in range(num_blocks):
            ...
            assert_equal(genhashes[x], maximushash_reversed(block[:80]).hex())
