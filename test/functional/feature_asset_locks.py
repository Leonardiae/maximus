...
class AssetLocksTest(MaximusTestFramework):
    def set_test_params(self):
        self.set_maximus_test_params(5, 3, [["-whitelist=127.0.0.1", "-llmqtestinstantsenddip0024=llmq_test_instantsend"]] * 5, evo_count=3)
