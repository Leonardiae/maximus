 ...
 *  We have 4 times smaller block times in Maximus, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        Maximus Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // MAXIMUS this code also handles non-TXs (Maximus specific messages)
