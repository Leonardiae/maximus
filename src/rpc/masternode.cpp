...
static void masternode_list_help(const JSONRPCRequest& request)
{
    RPCHelpMan{"masternodelist",
        ...
        "  owneraddress   - Print the masternode owner Maximus address\n"
        "  payee          - Print the masternode payout Maximus address (can be additionally filtered,\n"
        "                   partial match)\n"
        "  pubKeyOperator - Print the masternode operator public key\n"
        "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
        "                   (can be additionally filtered, partial match)\n"
        "  votingaddress  - Print the masternode voting Maximus address\n",
        {
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    { "maximus",               "masternode",             &masternode,             {} },
    { "maximus",               "masternodelist",         &masternode,             {} },
};
// clang-format on
