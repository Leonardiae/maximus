...
static UniValue addnode(const JSONRPCRequest& request)
{
    ...
    RPCHelpMan{"addnode",
        ...
        RPCResult{RPCResult::Type::NONE, "", ""},
        RPCExamples{
            HelpExampleCli("addnode", "\"192.168.0.6:9939\" \"onetry\"")
    + HelpExampleRpc("addnode", "\"192.168.0.6:9939\", \"onetry\"")
        },
    }.Check(request);
...
static UniValue disconnectnode(const JSONRPCRequest& request)
{
    RPCHelpMan{"disconnectnode",
        ...
        RPCResult{RPCResult::Type::NONE, "", ""},
        RPCExamples{
            HelpExampleCli("disconnectnode", "\"192.168.0.6:9939\"")
    + HelpExampleCli("disconnectnode", "\"\" 1")
    + HelpExampleRpc("disconnectnode", "\"192.168.0.6:9939\"")
...
static UniValue addpeeraddress(const JSONRPCRequest& request)
{
    RPCHelpMan{"addpeeraddress",
        ...
        RPCExamples{
            HelpExampleCli("addpeeraddress", "\"1.2.3.4\" 9939")
    + HelpExampleRpc("addpeeraddress", "\"1.2.3.4\", 9939")
        },
    }.Check(request);
