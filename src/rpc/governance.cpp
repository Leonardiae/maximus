...
static UniValue gobject_prepare(const JSONRPCRequest& request)
{
    ...
    // This command is dangerous because it consumes 5 MAXIMUS irreversibly.
    // If params are lost, it's very hard to bruteforce them and yet
    // users ignore all instructions on maximuscentral etc. and do not save them...
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    /* Maximus features */
    { "maximus",               "getgovernanceinfo",      &getgovernanceinfo,      {} },
    { "maximus",               "getsuperblockbudget",    &getsuperblockbudget,    {"index"} },
    { "maximus",               "gobject",                &gobject,                {} },
    { "maximus",               "voteraw",                &voteraw,                {"tx_hash","tx_index","gov_hash","signal","outcome","time","sig"} },
