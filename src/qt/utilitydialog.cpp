    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:  maximus-qt [command-line options]                     \n";
...
All the Maximus in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 MAXIMUS, 0.01 MAXIMUS, 0.1 MAXIMUS, 1 MAXIMUS and 10 MAXIMUS -- sort of like the paper money you use every day.</li> \
