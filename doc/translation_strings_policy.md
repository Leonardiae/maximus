...
This document provides guidelines for internationalization of the Maximus Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `maximus_en.ts` remains unchanged.
