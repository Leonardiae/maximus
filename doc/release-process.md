...
* [ ] Update manpages, see [gen-manpages.sh](https://github.com/maximus-labs/maximus/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
_Note: this step can be skipped if [our CI](https://github.com/maximus-labs/maximus/blob/master/ci/test/00_setup_env.sh#L64) still uses bitcoin's SDK package (see SDK_URL)_
...
- Detached signatures will then be committed to the [maximus-detached-sigs](https://github.com/maximus-labs/maximus-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
