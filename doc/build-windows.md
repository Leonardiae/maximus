...
Below are some notes on how to build Maximus Core for Windows.
...
way. This will install to `c:\workspace\maximus`, for example:

    make install DESTDIR=/mnt/c/workspace/maximus
